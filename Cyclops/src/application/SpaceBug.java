...
public class SpaceBug extends EnemyController{
	...
	public final static double      IMAGE_X_SIZE  = 70;
    public final static double      IMAGE_Y_SIZE  = 70;
    ...
    public void draw () { 
        ...
        imgEnemy.add(new ImageView(new Image(getClass().getClassLoader().getResource("resources/BossGalaga.png").toString())));        
