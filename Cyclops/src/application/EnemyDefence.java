...
public class EnemyDefence extends EnemyController{
	...
	public final static double      IMAGE_X_SIZE  = 256;
    public final static double      IMAGE_Y_SIZE  = 256;
    ...
    public void draw () { 
        ...
        imgEnemy.add(new ImageView(new Image(getClass().getClassLoader().getResource("resources/purpleBug.png").toString())));        
